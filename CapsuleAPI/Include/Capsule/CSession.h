 ...
 */
CL_DLL clCSession clCClient_CreateSession(clCClient client, clCDevice device) NOEXCEPT;
CL_DLL clCSession clCClient_CreateSessionWithMonopolarChannels(clCClient client,
                                                               clCDevice device) NOEXCEPT;
